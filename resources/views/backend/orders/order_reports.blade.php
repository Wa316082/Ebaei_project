                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="mb-4 border shadow-sm p-3">
                        <form action="{{ url('admin/order/reports.download') }}" method="" class="d-flex row">
                            <div class="col-md-6">
                            ...
                            <div class="mt-3"><button type="submit" class="btn btn-success"><span><i class="fas fa-regular fa-circle-down"></i></span> Download</button></div>
                        </form>
                    </div>
