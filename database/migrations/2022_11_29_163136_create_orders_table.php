...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            $table->integer('reciever_contact')->nullable();
            $table->string('reciever_email')->nullable();
            $table->integer('reciever_country_id')->nullable();
            $table->integer('reciever_zone_id')->nullable();
            $table->integer('reciever_area_id')->nullable();
            $table->integer('reciever_post_code')->nullable();
